    ...
    <main className="status-page status-page-error">
      ...
      <section className="status-stage">
        <div className="status-copy">
          ...
          <p>
            The newsroom is still online. Retry the request, or return to the homepage while we resolve the problem.
          </p>
          <div className="status-actions">
            <button className="status-action primary" type="button" onClick={reset}>
